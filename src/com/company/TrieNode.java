...
public class TrieNode
{
    ...
    protected void addWord(String word)
    {
        ...
        {
         //   if(children[charPos].lastLine!=i){
          //      children[charPos].lineCount++;
          //  }
            //children[charPos].lastLine=i;
            children[charPos].count++;

            children[charPos].isWord = true;
            if(children[charPos].id ==-1){
                children[charPos].id=ID;
                ID++;
            }
        }
    }
    ...
    public List getWords()
    {
        ...
        if (isWord)
        {
            list.add(id+"\t"+toString()+"\t"+ lineCount+"\t"+count);
        }
